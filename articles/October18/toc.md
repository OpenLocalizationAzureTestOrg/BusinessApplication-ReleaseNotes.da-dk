...
### [Videoindhold ved hjælp af Microsoft Stream](dynamics365-marketing/marketing/video-content-using-stream.md)
...
#### [Oversigt over nyheder](service/customer-service-omni-channel-release-notes/index.md)
...
#### [Opdateringer af anvendelighed og produktivitet](dynamics365-finance-operations/usability-productivity.md)
...
#### [Forbedret funktionalitet for SharePoint-formularer](powerapps/enhanced-sharepoint-forms-functionality.md)
...
#### [Forbedringer af deling](powerapps/sharing-enhancements.md)
...
#### [Reporting Services-rapporter i Dynamics 365 er nu tilgængelige](powerapps/reporting-services-reports-in-dynamics-365-are-now-accessible.md)
...
#### [Forbedringer af akkumuleringsvisninger i Common Data Service til apps](powerapps/enhancements-to-roll-up-views-in-common-data-service.md)
#### [Mere pålidelig Outlook-klient v8.2 til Common Data Service til apps](powerapps/more-reliable-outlook-client-v8.2-for-common-data-service.md)
#### [Mere pålidelig Outlook-klient v9.0 til Common Data Service til apps](powerapps/more-reliable-outlook-client-v9.0-for-common-data-service.md)
...
#### [Understøttelse af stedfortræderbrugere i Common Data Service til apps](powerapps/support-for-delegate-users-in-common-data-service.md)
...
#### [Automatisk fuldstændig installation af Power BI Embedded-løsninger](intelligence-platform/power-bi-embedded/automatic-end-end-deployment-pbi-embedded-solutions.md)
#### [Udrulning af et opdateret dashboard eller felt til produktion](intelligence-platform/power-bi-embedded/deploy-updated-dashboard-or-tile-production.md)
#### [Logføring af fejlhændelser](intelligence-platform/power-bi-embedded/enable-developers-troubleshoot.md)
#### [Forbedrede opdaterings-API'er](intelligence-platform/power-bi-embedded/improved-refresh-apis.md)
